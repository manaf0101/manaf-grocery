                        ...
                        <div className="grid grid-rows-2 h-full">
                            ...
                            <div className="row-start-1 flex justify-center items-center">
                                <svg width="138" height="138" viewBox="0 0 138 138" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M60.375 57.5L56.0625 53.1875" stroke="#33363F" stroke-linecap="round" />
                                    ...
                                    <rect x="46" y="103.5" width="11.5" height="20.125" rx="3" stroke="#222222" stroke-linejoin="round" />
                                    <rect x="11.5" y="103.5" width="11.5" height="20.125" rx="3" stroke="#222222" stroke-linejoin="round" />
                                    <path d="M11.5 106.375V115" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M57.5 106.375V115" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M57.5 106.375C57.5 99.5125 55.0768 92.9311 50.7635 88.0786C46.4501 83.2261 40.6 80.5 34.5 80.5C28.4 80.5 22.5499 83.2261 18.2365 88.0786C13.9232 92.9311 11.5 99.5125 11.5 106.375" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M93.4375 61.8125H113.562" stroke="#33363F" stroke-linecap="round" />
                                    <path d="M103.5 60.375V48.875" stroke="#33363F" stroke-linecap="round" />
                                    <path d="M85.375 23.5H121.625C122.111 23.5 122.424 23.5011 122.656 23.5322C122.873 23.5613 122.94 23.6084 122.979 23.6464C123.017 23.6845 123.064 23.7525 123.093 23.9694C123.124 24.2006 123.125 24.5145 123.125 25V32.875C123.125 36.6604 123.124 39.4491 122.837 41.5866C122.551 43.7096 121.991 45.1151 120.928 46.1783C119.865 47.2415 118.46 47.8011 116.337 48.0866C114.199 48.3739 111.41 48.375 107.625 48.375H99.375C95.5896 48.375 92.8009 48.3739 90.6634 48.0866C88.5404 47.8011 87.1349 47.2415 86.0717 46.1783C85.0085 45.1151 84.4489 43.7096 84.1634 41.5866C83.8761 39.4491 83.875 36.6604 83.875 32.875V25C83.875 24.5145 83.8761 24.2006 83.9072 23.9694C83.9363 23.7525 83.9834 23.6845 84.0214 23.6464C84.0595 23.6084 84.1275 23.5613 84.3444 23.5322C84.5756 23.5011 84.8895 23.5 85.375 23.5Z" stroke="#33363F" stroke-linecap="round" />
                                    ...
                                    <path d="M110.688 129.375V113.125C110.688 112.573 110.24 112.125 109.687 112.125H97.3125C96.7602 112.125 96.3125 112.573 96.3125 113.125V129.375" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
